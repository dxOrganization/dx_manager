 ...
 */
package com.thinkgem.jeesite.modules.complaint.web;
...
import com.thinkgem.jeesite.modules.complaint.service.ComplaintService;
...
public class ComplaintController extends BaseController {
	...
	public String list(Complaint complaint, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/complaint/complaintList";
	}
	...
	public String form(Complaint complaint, Model model) {
		...
		return "modules/complaint/complaintForm";
	}
