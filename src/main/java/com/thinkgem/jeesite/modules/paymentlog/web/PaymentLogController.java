 ...
 */
package com.thinkgem.jeesite.modules.paymentlog.web;
...
import com.thinkgem.jeesite.modules.paymentlog.entity.PaymentLog;
import com.thinkgem.jeesite.modules.paymentlog.service.PaymentLogService;
...
public class PaymentLogController extends BaseController {
	...
	public String list(PaymentLog paymentLog, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/paymentlog/paymentLogList";
	}
	...
	public String form(PaymentLog paymentLog, Model model) {
		...
		return "modules/paymentlog/paymentLogForm";
	}
